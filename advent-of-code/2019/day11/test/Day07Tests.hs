...
simulateInputToOutput :: Map Int64 Int64 -> [Int64] -> [Int64]
simulateInputToOutput memory input = simulateOutput $ makeStateWithInput input memory

expectSingle :: [Int64] -> Int64
expectSingle [a] = a
expectSingle a = error (printf "expected single element, got %s" (show a))

simulateThrusterSettings :: Map Int64 Int64 -> (Int64, Int64, Int64, Int64, Int64) -> Int64
...
simulateThrusterSettingsFeedback :: Map Int64 Int64 -> (Int64, Int64, Int64, Int64, Int64) -> Int64
...
allCombinations :: Int64 -> Int64 -> [(Int64, Int64, Int64, Int64, Int64)]
...
solvePart1 :: T.Text -> ((Int64, Int64, Int64, Int64, Int64), Int64)
solvePart1 input =
  (bestComb, bestAnswer)
  where
...
solvePart2 :: T.Text -> ((Int64, Int64, Int64, Int64, Int64), Int64)
solvePart2 input =
  (bestComb, bestAnswer)
  where
    memory = readMemory input
